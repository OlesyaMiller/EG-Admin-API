...
LiveEventModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([live_event_entity_1.LiveEvent])],
        controllers: [live_event_controller_1.LiveEventController],
        providers: [live_event_service_1.LiveEventService, config_1.ConfigService],
        exports: [live_event_service_1.LiveEventService]
    })
], LiveEventModule);
